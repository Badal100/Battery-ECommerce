<?php echo $__env->make('topheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <div class="container">
    <div class="slider-container has-scrollbar">
      <div class="slider-item">
        <img
          src="./assets/images/Battery/battery7.jpg"
          alt="women's latest fashion sale"
          class="banner-img"
        />

        <div class="banner-content">
          <p class="banner-subtitle">INDIA'S NUMBER 1</p>

          <h2 class="banner-title">ONLINE BATTERY PLATFORM</h2>

          <p class="banner-text">starting at ₹<b>2000</b></p>

          <a href="/car-battery" class="banner-btn">Buy now</a>
        </div>
      </div>

      <div class="slider-item">
        <img
          src="./assets/images/Battery/battery8.jpg"
        ...
        <div class="banner-content">
          ...
          <a href="/bike-battery" class="banner-btn">Buy now</a>
        </div>
      </div>

      <div class="slider-item">
        <img
          src="./assets/images/Battery/battery9.jpg"
        ...
        <div class="banner-content">
          ...
          <a href="/truck-battery" class="banner-btn">Buy now</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="product-container">
      ...
      <div class="container">
        ...
        <div class="product-box">
          ...
          <div class="product-minimal" style="display: none;">
          ...
          <div class="product-featured">
            ...
            <h2 class="title">Battery Categories</h2>
              ...
              <div class="showcase-container">
                ...
                <div class="showcase">
                  ...
                  <div class="showcase-banner">
                    <img src="./assets/images/Battery/battery2.jpg" alt="shampoo, conditioner & facewash packs" class="showcase-img">
                  </div>

                  <div class="showcase-content">

                    <a href="#">
                      <h3 class="showcase-title">Bike Battery</h3>
                    </a>
                    ...
                    <a href="/bike-battery"><button class="add-cart-btn">view more</button></a>
            ...
            <div class="showcase-wrapper has-scrollbar">
              ...
              <div class="showcase-container">
                ...
                <div class="showcase">
                  ...
                  <div class="showcase-banner">
                    <img src="./assets/images/Battery/battery4.jpg" alt="shampoo, conditioner & facewash packs" class="showcase-img">
                  </div>

                  <div class="showcase-content">

                    <a href="#">
                      <h3 class="showcase-title">Car Battery</h3>
                    </a>
                    ...
                    <a href="/car-battery"><button class="add-cart-btn">view more</button></a>
                  </div>
            ...
            <div class="showcase-wrapper has-scrollbar">
              ...
              <div class="showcase-container">
                ...
                <div class="showcase">
                  ...
                  <div class="showcase-banner">
                    <img src="./assets/images/Battery/battery6.jpg" alt="shampoo, conditioner & facewash packs" class="showcase-img">
                  </div>

                  <div class="showcase-content">
    
                    <a href="#">
                      <h3 class="showcase-title">Truck Battery</h3>
                    </a>
                    ...
                    <a href="/truck-battery"><button class="add-cart-btn">view more</button></a>
                  </div>
            ...
            <div class="product-grid">
              ...
              <div class="showcase">
                ...
                <div class="showcase-banner">
                  ...
                  <img src="./assets/images/Battery/battery1.jpg" alt="Mens Winter Leathers Jackets" width="300" class="product-img default">
                  <img src="./assets/images/Battery/battery1.jpg" alt="Mens Winter Leathers Jackets" width="300" class="product-img hover">
              ...
              <div class="showcase">
                ...
                <div class="showcase-banner">
                  <img src="./assets/images/Battery/battery2.jpg" alt="Pure Garment Dyed Cotton Shirt" class="product-img default"
                    width="300">
                  <img src="./assets/images/Battery/battery2.jpg" alt="Pure Garment Dyed Cotton Shirt" class="product-img hover"
                    width="300">
              ...
              <div class="showcase">
                ...
                <div class="showcase-banner">
                  <img src="./assets/images/Battery/battery3.jpg" alt="MEN Yarn Fleece Full-Zip Jacket" class="product-img default"
                    width="300">
                  <img src="./assets/images/Battery/battery3.jpg" alt="MEN Yarn Fleece Full-Zip Jacket" class="product-img hover"
                    width="300">
              ...
              <div class="showcase">
                ...
                <div class="showcase-banner">
                  <img src="./assets/images/Battery/battery4.jpg" alt="Black Floral Wrap Midi Skirt" class="product-img default"
                    width="300">
                  <img src="./assets/images/Battery/battery4.jpg" alt="Black Floral Wrap Midi Skirt" class="product-img hover"
                    width="300">
              ...
              <div class="showcase">
                ...
                <div class="showcase-banner">
                  <img src="./assets/images/Battery/battery5.jpg" alt="Casual Men's Brown shoes" class="product-img default"
                    width="300">
                  <img src="./assets/images/Battery/battery5.jpg" alt="Casual Men's Brown shoes" class="product-img hover"
                    width="300">
              ...
              <div class="showcase">
                ...
                <div class="showcase-banner">
                  <img src="./assets/images/Battery/battery5.jpg" alt="Pocket Watch Leather Pouch" class="product-img default"
                    width="300">
                  <img src="./assets/images/Battery/battery5.jpg" alt="Pocket Watch Leather Pouch" class="product-img hover"
                    width="300">
              ...
              <div class="showcase">
                ...
                <div class="showcase-banner">
                  <img src="./assets/images/Battery/battery6.jpg" alt="Smart watche Vital Plus" class="product-img default"
                    width="300">
                  <img src="./assets/images/Battery/battery6.jpg" alt="Smart watche Vital Plus" class="product-img hover" width="300">
              ...
              <div class="showcase">
                ...
                <div class="showcase-banner">
                  <img src="./assets/images/Battery/battery1.jpg" alt="Womens Party Wear Shoes" class="product-img default"
                    width="300">
                  <img src="./assets/images/Battery/battery1.jpg" alt="Womens Party Wear Shoes" class="product-img hover"
                    width="300">
...
</html><?php /**PATH D:\Share Folder\Projects\E-Commerce\resources\views/welcome.blade.php ENDPATH**/ ?>